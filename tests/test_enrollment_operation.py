    ...
    def test_progress_continue_and_identity_are_journaled_and_secret_wiped(self):
        ...
        transport = FakeTransport(
            [
                ...
                raw_event(11, protocol.SERVICE_STATUS, 1, 55),
                raw_event(12, protocol.SERVICE_STATUS, 1, 64),
                raw_event(13, protocol.SERVICE_STATUS, 1, 90),
                raw_event(14, protocol.SERVICE_STATUS, 1, 263),
                raw_event(
                    15,
